        ...
        <div class="shadowed-bottom">
          <div class="row">
            <form method="post" action="https://world.ccavenue.com/servlet/ccw.CCAvenueController">
               <input type="hidden" name="Merchant_Id" value="M_demos_17">
               ...
               <input type="hidden" name="billing_cust_name" value="Abraham">
        ...
        <ul class="users-list">
          <li>
            <div class="row">
              <div class="col-xs-2">
                <div class="avatar">
                  <img src="<?php echo base_url('assets/admin-assets'); ?>/assets/images/avatar-small.jpg" alt="">
                </div>
              </div>
              <div class="col-xs-10">
